                    ...
                    $adminNavSections = [
                        [
                            ...
                            'items' => [
                                ...
                                ['label' => 'Head-to-Head', 'icon' => 'swords', 'url' => '/admin/head-to-head', 'permission' => 'tournaments.view'],
                        ...
                        [
                            ...
                            'items' => [
                                ...
                                ['label' => 'Translations', 'icon' => 'languages', 'url' => '/admin/translations', 'permission' => 'translations.view'],
                            ],
                        ],
                        [
                            'label' => 'System',
                            'items' => [
                                ...
                                ['label' => 'Staff Activity', 'icon' => 'activity', 'url' => '/admin/staff-activity', 'permission' => 'staff_activity.view'],
                                ...
                                ['label' => 'Newsletters', 'icon' => 'mail', 'url' => '/admin/newsletters', 'permission' => 'newsletters.view'],
                                ['label' => 'Advertisements', 'icon' => 'badge-percent', 'url' => '/admin/advertisements', 'permission' => 'advertisements.view'],
                                ['label' => 'Player Reviews', 'icon' => 'star', 'url' => '/admin/player-reviews', 'permission' => 'player_reviews.view'],
                                ['label' => 'Geo-Blocking', 'icon' => 'globe', 'url' => '/admin/geo-blocking', 'permission' => 'geo_blocking.view'],
