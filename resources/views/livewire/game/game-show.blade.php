...
@endphp
<div class="player-game-hub space-y-8">
    ...
    @elseif($activeTab === 'browse')
        <section class="space-y-6">
            ...
            <div class="player-filter-panel rounded-2xl border border-zinc-800 bg-zinc-900/40 p-4 sm:p-5"><div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
